...
const NOTICE_KEY = "klawus-notice-v3";
...
const heroSide = {
  top: {
    cat: "cat-mail",
    category: "우편 사기",
    title: "엄마는 우편을 정말 믿었다 — USPS 환급 사칭 한 통의 결말"
  },
  list: [
    "K-Drive Used Auto — 시세 30% 낮은 매물, 연락 두절 8건",
    "Renovation Star NJ — 계약금 50% 선납 후 공사 미진척 5건",
...
const sideMiniReports = [
  "퇴거 30일 지나도록 보증금 정산서 미수령",
  "고배당 약속 동업, 1년 만에 잠적",
  "리모델링 6개월째 미시공, LLC 두 번 변경",
  "‘변호사 친구’가 USCIS에 접수도 안 했다",
  "K-Town 가짜 이민 컨설팅 의뢰비 환불 거부"
];
...
const newsSplit = {
  ...
  list: [
    "가짜 식자재 도매 ‘원금 보장’ 약속 — 한인 교회 인맥으로 모집",
    "USPS 봉투에 한국어 환급 통지 — Fort Lee·Cliffside Park 직격",
    "거래처 메일 한 글자 위장 — 결제 직전 ‘긴급 계좌 변경’ 사례",
    "Manhattan K-Town 무자격 이민 컨설팅 11건 — Bar 신고 진행",
    "K-Drive Used Auto — 시세 30% 낮은 매물, 운송보험 명목 추가 결제",
    "박OO(개인) — ‘한국 가족 의료비’ 명목 동시 차용 6건"
  ]
};
...
const columns4 = [
  ...
  },
  {
    cat: "cat-crime",
    field: "형사 · 사기",
    title: "형사 고소와 민사 회수, 동시에 가능한가",
    excerpt: "‘일단 형사부터’가 늘 옳지는 않다. 피해 회복이 목표라면 민사·집단소송이 우선될 때도 많다.",
    author: "이정현 변호사", detail: "NY Criminal Defense · Manhattan · 15년",
    sponsor: { label: "형사·사기·횡령 변호", who: "한지윤 변호사 (Han Defense Group)", contact: "(212) 555-0341 · han-defense.com" }
  },
  {
    cat: "cat-community",
    field: "이민·무자격 컨설팅 피해",
    title: "무자격 ‘이민 컨설팅’에 속았을 때 — 절차 복구는 가능한가",
    excerpt: "USCIS 접수 자체가 안 된 사례, 위조 영수증 사례를 본 적이 있다. 시간 손실은 막기 어렵지만 자료 복원과 새 진행은 가능하다.",
    author: "정유라 변호사", detail: "NY Immigration · Bayside · 9년",
    sponsor: { label: "이민·영주권·USCIS 절차", who: "조선호 변호사 (Cho Immigration Law)", contact: "(718) 555-0228 · cho-immi.com" }
  },
  {
    cat: "cat-finance",
    field: "동업·계약 분쟁",
    title: "Operating Agreement 한 줄이 회사를 살린다",
...
const scammers = [
  { cat:"cat-realestate", name:"이OO (Lee Property Holdings)", type:"이중 임대", location:"Flushing, Queens, NY", aliases:"Lee Realty Inc, OO Properties LLC", cases:7, status:"evidence",
  ...
  { cat:"cat-finance", name:"FoodLink Korea Trading", type:"동업 투자금 편취", location:"Bergen County, NJ", aliases:"K-Foodlink LLC, OO Distribution", cases:14, status:"evidence",
  ...
  { cat:"cat-realestate", name:"Renovation Star NJ", type:"공사대금 먹튀", location:"Fort Lee · Edgewater, NJ", aliases:"Star Builders LLC, OO Home Renovation", cases:5, status:"pending",
    brief:"계약금 50% 선납 후 자재값 추가 송금, 미진척",
  ...
  { cat:"cat-realestate", name:"Palisades Park Properties", type:"보증금 미반환", location:"Palisades Park · Leonia, NJ", aliases:"PPP Management Group", cases:9, status:"screened",
    brief:"30일 내 정산 의무 위반, 임의 공제 다수",
  ...
  { cat:"cat-community", name:"박OO (개인)", type:"악의적 차용 미상환", location:"Bayside · Cliffside Park, NJ", aliases:"Park OO 등 다수", cases:6, status:"screened",
  ...
  { cat:"cat-digital", name:"K-Drive Used Auto", type:"중고차 마켓 사기", location:"Online (NY·NJ 배송)", aliases:"Auto K Used, K-Auto Trading", cases:8, status:"pending",
  ...
  { cat:"cat-crime", name:"USA Visa Korea OO", type:"유사 법률·무자격 이민 컨설팅", location:"Manhattan K-Town (32nd St)", aliases:"Korea Visa Center, OO Immigration Consulting", cases:11, status:"evidence",
    brief:"변호사 자격 없이 비자 대행, USCIS 미접수",
  ...
  { cat:"cat-mail", name:"USPS·IRS 환급 사칭 우편", type:"우편 사기 (Mail Scam)", location:"NY·NJ 일대 발송", aliases:"IRS 환급, 한국 세무서, USCIS 환급", cases:19, status:"evidence",
    brief:"한국어 환급 통지 위조, 수수료 Zelle 송금 유도",
...
const scamTypes = [
  ...
  { num:"03", title:"공사대금 먹튀", sign:"계약금 50% 선납, 자재 명목 추가 송금 유도", flag:"HIC 라이선스 미보유, LLC 명의 변경", act:"NJ DCA·NY DOS 라이선스 조회, 단계별 지급" },
  { num:"04", title:"보증금 미반환", sign:"퇴거 후 14일(NY)·30일(NJ) 내 정산 무시", flag:"이메일 응답 회피, 영수증 없음", act:"독촉 서한 → 소액심판(NY Civil·NJ Special Civil)" },
  { num:"05", title:"악의적 차용 미상환", sign:"여러 명에게 동시 차용, 변제 약속 반복 불이행", flag:"차용증·송금 사유 미기재, 새 사업체로 재활동", act:"차용증·문자·송금 확보, Promissory Note 청구" },
  { num:"06", title:"유사 법률·이민 컨설팅", sign:"변호사 자격 없이 비자·소송 대행 광고", flag:"NY/NJ State Bar 미등록, 공유 오피스", act:"State Bar Search 조회, 의심 시 Bar에 제보" },
  { num:"07", title:"중고차 마켓 사기", sign:"시세보다 낮은 가격, 즉시 결제·픽업 유도", flag:"차량 미실물, 운송 보험 명목 추가 결제", act:"차량 직접 확인, VIN 조회, 결제는 만남 후" },
  { num:"08", title:"선결제 후 폐업·도주", sign:"연간 패키지 결제 유도 후 폐업", flag:"‘선결제 시 할인’ 강매, 양수도 후 책임 부인", act:"선결제 자제, 카드 결제 + Chargeback 권리" },
  { num:"09", title:"우편 사기 (Mail Scam)", sign:"IRS·USCIS·세무서 사칭 우편으로 환급 통지", flag:"공식 인장 위조, ‘24시간 회신’ 압박", act:"USPS Postal Inspection(1-877-876-2455) 신고" },
  { num:"10", title:"한국어 보이스피싱", sign:"검찰·영사관 사칭 ‘체포영장’ 위협", flag:"발신 번호 위장, 즉시 송금·기프트카드 요구", act:"즉시 통화 종료, 기관 공식 번호로 직접 확인" },
  { num:"11", title:"비즈니스 이메일 침해 (BEC)", sign:"거래처·임원 이메일 위조, 결제 계좌 변경", flag:"도메인 한 글자 다름, ‘긴급’ 사유", act:"계좌 변경은 반드시 전화 재확인" },
  { num:"12", title:"로맨스·교제 사기", sign:"앱·SNS 친분 후 ‘급한 의료비·세관 수수료’", flag:"만남·영상통화 회피, 사진 도용", act:"사진 역검색, 영상 거부 시 차단·FBI IC3 신고" }
];

const reliefSteps = [
  { num:"단계 01", when:"0-24시간 · 즉시", title:"증거를 잃지 마라",
    items:["문자·이메일·통화기록 스크린샷","송금 내역(Zelle/Wire/카드) PDF","계약서·영수증·우편 원본 보관","은행에 즉시 ‘사기 의심’ 통보"] },
  { num:"단계 02", when:"1-7일 · 신고", title:"신고처를 분산하라",
    items:["FBI IC3 (ic3.gov)","USPS Postal Inspection","NY 검찰청 / NJ Division of Consumer Affairs","지역 경찰서 사건 번호 확보"] },
  { num:"단계 03", when:"2-4주 · 법적 검토", title:"민사·형사 동시 검토",
    items:["민사: 소액심판·일반 민사 청구","형사: 검찰·FBI 고소","Promissory Note·계약서 있으면 즉시","K-lawus 경고 명단 등재"] },
  { num:"단계 04", when:"1-3개월 · 회수", title:"회수와 재발 방지",
    items:["자산·급여·은행 압류","신용 기록·보험 청구 영향 점검","동일 가해자 신규 활동 모니터링","사례 익명 게재로 다음 피해자 차단"] }
];
...
function Box({ id, name, more = "더보기", children }) {
  return (
...
export default function HomePage() {
  ...
  return (
    <>
      {notice && (
        <div
          className="notice-overlay" role="dialog" aria-modal="true"
        ...
        <div className="container">
          <div className="body-grid">
            <div className="col-main">
                  ...
                  {columns4.map((c) => (
                    <article key={c.title} className="column-card">
                      ...
                      <div className="column-body">
                        <div className="cat-line">{c.field}</div>
                        <h3>{c.title}</h3>
              ...
              <Box id="relief" name="피해자 구제 가이드">
                <div className="relief-grid">
                  {reliefSteps.map((s) => (
                    <article key={s.num} className="relief-step">
              ...
              <Box id="directory" name="분야별 변호사 찾기">
            ...
            <aside className="col-side" aria-label="사이드">
              <div className="side-block">
                <div className="side-head"><span>인기 사례 TOP 5</span><a href="#registry">전체 →</a></div>
              ...
              <div className="ad-slot tall" aria-label="광고">
                <div>
                  <strong>AD</strong>
                  광고 슬롯 — 사진 없는 텍스트 광고만<br/>
                  ads@klawus.com
                </div>
              </div>

              <div className="side-block">
                <div className="side-head"><span>최근 제보</span><a href="#voices">전체 →</a></div>
                <div className="side-body">
                  <ul className="mini-list">
                    {sideMiniReports.map((r) => <li key={r}>{r}</li>)}
                  </ul>
                </div>
              </div>

              <div className="side-block">
                <div className="side-head"><span>구제 가이드 단계</span><a href="#relief">전체 →</a></div>
                <div className="side-body">
                  <ul className="mini-list">
                    {reliefSteps.map((s) => <li key={s.title}>{s.title} <span className="muted">— {s.when}</span></li>)}
                  </ul>
                </div>
              </div>
